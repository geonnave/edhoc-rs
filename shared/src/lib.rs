...
mod edhoc_parser {
    ...
    pub fn decode_plaintext_2(
        ...
        debug!("Enter decode_plaintext_2");
    ...
    pub fn decode_plaintext_3(
        ...
        debug!("Enter decode_plaintext_3");
